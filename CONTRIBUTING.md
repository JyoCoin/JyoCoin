...
posted to #jyocoin-dev on irc.freenode.net).
...
Copyright (c) 2018 Jyocoin Project, Derived from 2018, The Monero Project.
...
The "jyocoin Maintainer Team" is defined in this document as the following users:
- fluffypony
- jyocoinmooo
- hyc
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to jyocoin code or jyocoin's dependency code or jyocoin's potential/future dependency code or research which successfully implements jyocoin.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the jyocoin Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the jyocoin Maintainer Team.
